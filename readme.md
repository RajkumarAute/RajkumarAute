...
1. Built & automated the CI/CD process using Azure DevOps, Git, Jenkins & buddy.works.
0. Kubernetes, AWS EKS, ECS, & Docker tools are used to build containerized infra & Terraform used to build AWS infra.
